        ...
        <Routes>
          <Route path={AppRoute.index} element={<Layout />}>
            ...
            <Route
              path={AppRoute.auth}
              element={
                <Page title="Auth Form: Sign In" hasRedirectToHomeIfAuth>
                  <AuthPage />
                </Page>
              }
            />
            <Route
              ...
              element={
                <Page title="Auth Form: Sign Up" hasRedirectToHomeIfAuth>
                  <RegisterPage />
                </Page>
              }
            />
            <Route
              ...
              element={
                <Page title="Auth Form: Page Not Found">
                  <ErrorPage />
                </Page>
              }
            />
